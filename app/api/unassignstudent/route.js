...
export async function DELETE(request) {
    try {
        ...
        const courseId = searchParams.get("courseID"); // Assuming the postId is passed in the query params
        const studentId = searchParams.get("studentID"); // Assuming the postId is passed in the query params
